...
| `artifacts/policy/policy_results.pkl` | Notebook 07 | Paper writing and Notebook 08 | Coarse-grid result diagnostics and decompositions |
| `artifacts/policy/global_transition_audit.pkl` | Notebook 08 | Paper writing | Global fine-grid overlap and adjacent schedule-transition diagnostics across capacities |
| `artifacts/cache/policy/*.pkl` | Notebooks 06 and 08 | Same notebook run | Regenerable; never a scientific source of truth |
