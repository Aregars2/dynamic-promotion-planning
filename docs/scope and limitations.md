# Empirical scope and simulation extension

The active repository is an empirical, model-based policy evaluation. It does not identify the causal profit effect of implementing the recommended calendars in stores.

The current evidence establishes that, under the estimated demand-displacement model:

1. terminal truncation can overstate dynamic value;
2. dynamic value is generally modest but localized near asynchronous discrete policy boundaries;
