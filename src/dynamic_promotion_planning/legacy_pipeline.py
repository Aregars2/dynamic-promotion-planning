"""Legacy monolithic analysis helpers.

This module is retained only for archived notebooks and backward compatibility.
The active empirical pipeline imports focused modules instead.
"""
